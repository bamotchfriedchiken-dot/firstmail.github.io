document.addEventListener("DOMContentLoaded", () => {
  ...
  async function generateEmail() {
    try {
      ...
      messagesDiv.innerHTML = `<p class="error">Error generating email</p>`;
      console.error(error);
    }
  }
  ...
  async function fetchMessages() {
    ...
    try {
      ...
      messagesDiv.innerHTML = `<p class="error">Error fetching messages</p>`;
      console.error(error);
    }
  }
  ...
  // Auto-générer un email au chargement
  generateEmail();
});
